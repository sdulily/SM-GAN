...
class TrainOptions():
  def __init__(self):
    ...
    self.parser.add_argument('--gpu_ids', type=int, default='1', help='gpu ids: e.g. 0')
    
    # data loader related
    self.parser.add_argument('--dataroot', type=str, default='dataset/Clevr/images_train_3_edit', help='path of data')
    ...
    self.parser.add_argument('--crop_size', type=str, default='256,256', help='cropped image size (w, h) for training')
    ...
    # model related
    self.parser.add_argument('--operator', type=str, default='ACM', help='adaroute.adaptive routing')
    self.parser.add_argument('--temperature', type=float, default=1., help='softmax temperature in operator')
    self.parser.add_argument('--w_gate', type=float, default=1., help='weight of the gate variance loss')#1.
    self.parser.add_argument('--num_adablock', type=int, default=4, help='Number of adaptive res blocks')#4
    ...
    # training related
    self.parser.add_argument('--lr', type=float, default=0.0002, help='learning rate')#0.0002 论文里写的是0.002
