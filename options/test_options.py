...
class TestOptions():
  def __init__(self):
    ...
    # gpu related
    self.parser.add_argument('--gpu_ids', type=int, default='0', help='gpu ids: e.g. 0')
    
    # data loader related
    self.parser.add_argument('--dataroot', type=str, default='dataset/Clevr/', help='path of data')
    ...
    self.parser.add_argument('--crop_size', type=str, default='320,240', help='cropped image size (w, h) for training')
    ...
    # ouptput related
    self.parser.add_argument('--name', type=str, default='clevr', help='folder name to save outputs')
    ...
    self.parser.add_argument('--num_adablock', type=int, default=1, help='Number of adaptive res blocks')
    self.parser.add_argument('--which_epoch', type=int, default=60, help='number of epoch to be loaded')
